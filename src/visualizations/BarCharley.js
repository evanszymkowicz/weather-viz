...
class BarCharley extends Component {
	state = {
		bars: [], //empty array to load
	...
	static getDerivedStateFromProps(nextProps, prevState) {
		...
		//this will run after the data has changed
		//supposed to highlight the high temp
